...
const FIELDS = [
  ...
  {
    key: 'auto_install_pi_extension',
    kind: 'bool',
    fallback: true,
    help: 'Install the Pi companion extension into the Pi agent directory (setup and every daemon start) and keep it refreshed; never over a foreign file. The Pi-extension action repairs or removes it by hand.',
  },
  {
